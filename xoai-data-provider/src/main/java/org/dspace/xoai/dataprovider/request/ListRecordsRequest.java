...
public class ListRecordsRequest extends PaginatedVerbRequest {
    ...
    public ListRecordsRequest(int offset, RequestedMetadataPrefix requestedMetadataPrefix, Optional<RequestedDate> from, Optional<RequestedDate> until, Optional<RequestedSet> requestedSet) {
        super(offset);
